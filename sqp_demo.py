...
def random_example_2():
    ...
    line_x = np.concatenate((np.linspace(x1, x2, num=100), np.linspace(x2, x3, num=100)), axis=0)
    line_y = np.concatenate((np.linspace(y1, y2, num=100), np.linspace(y2, y3, num=100)), axis=0)
