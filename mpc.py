...
system.set_dt(dt)
system.set_cost(
    np.diag([50.0, 50.0, 10.0, 1]), np.diag([30.0, 100.0]))
...
# init_inputs = mpc_optimizer.inputs
# mpc_optimizer_2= iterative_MPC_optimizer(system, mpc_optimizer.states, dt)
# mpc_optimizer_2.inputs = init_inputs
# mpc_optimizer_2()

# init_inputs = mpc_optimizer_2.inputs
# mpc_optimizer_3= iterative_MPC_optimizer(system, mpc_optimizer_2.states, dt)
# mpc_optimizer_3.inputs = init_inputs
# mpc_optimizer_3()
